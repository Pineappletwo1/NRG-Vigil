...
var indexApp = (function () {
    ...
    const file$7 = "app\\svelte\\index\\NavBar.svelte";
    ...
    const file$6 = "app\\svelte\\index\\Cards\\DataAccuracyCard.svelte";
    ...
    const file$5 = "app\\svelte\\index\\Cards\\DataCycleTimeCard.svelte";
    ...
    const file$4 = "app\\svelte\\index\\Cards\\DataHeatMapCard.svelte";
    ...
    const file$3 = "app\\svelte\\index\\Cards\\DataLeaderboardCard.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 32, 12, 1170);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 59, 4, 1586);
    			...
    			add_location(img, file$1, 67, 4, 1737);
    			attr_dev(p, "class", "text-text text-3xl font-medium mb-4");
    			add_location(p, file$1, 72, 4, 1875);
