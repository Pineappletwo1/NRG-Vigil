...
var indexApp = (function () {
    ...
    const file$2 = "app\\svelte\\index\\NavBar.svelte";
    ...
    // (29:4) {#each navItems as item, idx}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(span, "left", 12.5 + /*idx*/ ctx[9] * 25 + "%");
    			attr_dev(span, "role", "button");
    			attr_dev(span, "tabindex", "0");
    			add_location(span, file$2, 29, 6, 870);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(29:4) {#each navItems as item, idx}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 24, 2, 592);
    			attr_dev(div1, "class", "flex-1 relative h-full z-10");
    			add_location(div1, file$2, 27, 2, 786);
    			...
    			add_location(nav, file$2, 21, 0, 448);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 59, 2, 1468);
    			...
    			add_location(img, file$1, 67, 2, 1595);
    			attr_dev(p, "class", "text-text text-3xl font-medium mb-4");
    			add_location(p, file$1, 72, 2, 1717);
    			...
    			add_location(div, file$1, 50, 0, 1142);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 5, 0, 119);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, t);
    			mount_component(importpage, main, null);
    			current = true;
    		},
    		p: noop,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ NavBar, ImportPage });
    	return [];
    }
